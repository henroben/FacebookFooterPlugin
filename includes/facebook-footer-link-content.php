...
function ffl_add_footer($content) {
	...
	$footer_output .= '<span class="dashicons dashicons-facebook"></span> Find me on <a href="'. $ffl_options['facebook_url'] .'" target="_blank" style="color: '. $ffl_options['link_colour'] .'">Facebook</a>';
	$footer_output .= '</div>';
